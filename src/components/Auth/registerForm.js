      ...
      <Form className="signin-signup-form">
        <Grid>
          ...
          <span className="mt-2">
            ...
            <Link to={`${AppRoutes.PRIVACY_POLICY}${appendParams ? appendParams: ''}`} className="text-medium-blue">
              {intl(layoutMessages.privacyPolicyTitle)}
            </Link> { '' }
            & { '' }
            <Link to={`${AppRoutes.TERMS_OF_USE}${appendParams ? appendParams: ''}`} className="text-medium-blue">
