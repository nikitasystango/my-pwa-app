...
import SeoTags from 'common/SeoTags/index.js'
import SeoTexts from 'constants/seoConstants.js'
import './style.scss'
const ProfileDetails = (props) => {
  ...
  return (
    <>
      <SeoTags
        title={SeoTexts.NEW_PROFILE_TITLE}
        metaDescription={SeoTexts.NEW_PROFILE_DESCRIPTION}
        canonicalLink={SeoTexts.NEW_PROFILE_CANONICAL}
        ogImgUrl={SeoTexts.NEW_PROFILE_OG_IMAGE_URL}
        twitterImgUrl={SeoTexts.NEW_PROFILE_TWITTER_IMAGE_URL}
      />
